...
void main() {
    ...
    bool yborder = ypattern < (GRID_SQUARE / 2.f) + GRID_GAP && ypattern > (GRID_SQUARE / 2.f) + GRID_GAP - GRID_SIZE;
    bool xborder = xpattern < (GRID_SQUARE / 2.f) + GRID_GAP && xpattern > (GRID_SQUARE / 2.f) + GRID_GAP - GRID_SIZE;
